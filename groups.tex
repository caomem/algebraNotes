...
\begin{document}
	...
	\begin{teorema}
		Seja $p_{\mathbf x}\in \mathbb{H}_0$ um quatérnio associado a um vetor $\mathbf x\in\mathbb{R}^3$ dado. Então, o quatérnio unitário $q = \cos(\frac{1}{2}\theta) + \sin(\frac 1 2 \theta)\mathbf v$ induz uma rotação $\theta$ de $\mathbf x$ sobre o eixo $\langle \mathbf v\rangle$, determinando $\mathbf x'\in \mathbb{R}^3$, pelo mapa
		$$
		\begin{tabular}{rccl}
	...
	\input{secProteins/gphilippi.tex}
