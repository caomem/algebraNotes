...
\title{Álgebra Abstrata: notas de estudo}
...
\begin{definicao}[Corpo]
	Um \emph{corpo} $(F, +, \cdot)$ é um anel de divisão comutativo.
\end{definicao}
...
\begin{definicao}[Subcorpo]
	Seja um corpo $L$. Um corpo $k\leq L$ é dito \emph{subcorpo} de $L$ e $L$ é dito \emph{extensão} de $k$.
\end{definicao}
